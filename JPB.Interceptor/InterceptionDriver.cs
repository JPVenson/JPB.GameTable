...
namespace Interceptor
{
	...
	public enum FilterType
	{
		...
		/// <summary>
		/// Whitelisted devices will be handled but all other not
		/// </summary>
		Whitelist,
		/// <summary>
		/// Blacklisted devices will never be handeld but all other
		/// </summary>
		Blacklist
	}
	...
	public static class InterceptionDriver
	{
		...
		private const string InterceptionExtention = "JPB.Interception.Extention.dll";
		...
		[DllImport(InterceptionDll, EntryPoint = "interception_get_precedence", CallingConvention = CallingConvention.Cdecl)]
		public static extern void GetPrecedence(IntPtr context, Int32 device);

		[DllImport(InterceptionDll, EntryPoint = "interception_set_precedence", CallingConvention = CallingConvention.Cdecl)]
...
#if !OLD_API
		[DllImport(InterceptionExtention, EntryPoint = "interception_get_hardware_id_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Auto)]
		public static extern int GetHardwareID(IntPtr context, int device, [Out] char[] idbuffer, int length);

		[DllImport(InterceptionExtention, EntryPoint = "interception_set_keyboard_list", CallingConvention = CallingConvention.Cdecl)]
		public static extern void SetKeyboardList(Int32[] device, int length);

		[DllImport(InterceptionExtention, EntryPoint = "interception_set_mice_list", CallingConvention = CallingConvention.Cdecl)]
		public static extern void SetMiceList(Int32[] device, int length);

		[DllImport(InterceptionExtention, EntryPoint = "interception_is_keyboard_whitelist", CallingConvention = CallingConvention.Cdecl)]
		public static extern Int32 IsKeyboardWhitelist(Int32 device);

		[DllImport(InterceptionExtention, EntryPoint = "interception_is_mouse_whitelist", CallingConvention = CallingConvention.Cdecl)]
		public static extern Int32 IsMouseWhitelist(Int32 device);

		[DllImport(InterceptionExtention, EntryPoint = "interception_is_keyboard_blacklist", CallingConvention = CallingConvention.Cdecl)]
		public static extern Int32 IsKeyboardBlacklist(Int32 device);

		[DllImport(InterceptionExtention, EntryPoint = "interception_is_mouse_blacklist", CallingConvention = CallingConvention.Cdecl)]
		public static extern Int32 IsMouseBlacklist(Int32 device);
#endif
